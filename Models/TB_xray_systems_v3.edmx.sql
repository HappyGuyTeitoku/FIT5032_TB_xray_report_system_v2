...
IF OBJECT_ID(N'[dbo].[FK_PatientDeletionRequest]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[DeletionRequestSet] DROP CONSTRAINT [FK_PatientDeletionRequest];
GO
IF OBJECT_ID(N'[dbo].[FK_ScreeningHistoryScreeningImage]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[ScreeningImageSet] DROP CONSTRAINT [FK_ScreeningHistoryScreeningImage];
GO
IF OBJECT_ID(N'[dbo].[FK_ScreeningHistoryMedicalProfessional]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[ScreeningHistorySet] DROP CONSTRAINT [FK_ScreeningHistoryMedicalProfessional];
GO
IF OBJECT_ID(N'[dbo].[FK_ScreeningHistoryPatient]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[ScreeningHistorySet] DROP CONSTRAINT [FK_ScreeningHistoryPatient];
GO
IF OBJECT_ID(N'[dbo].[FK_ScreeningHistoryReport]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[ReportSet] DROP CONSTRAINT [FK_ScreeningHistoryReport];
GO
IF OBJECT_ID(N'[dbo].[FK_Patient_inherits_User]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[UserSet_Patient] DROP CONSTRAINT [FK_Patient_inherits_User];
GO
IF OBJECT_ID(N'[dbo].[FK_MedicalProfessional_inherits_User]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[UserSet_MedicalProfessional] DROP CONSTRAINT [FK_MedicalProfessional_inherits_User];
GO
...
GO
IF OBJECT_ID(N'[dbo].[DeletionRequestSet]', 'U') IS NOT NULL
    DROP TABLE [dbo].[DeletionRequestSet];
GO
IF OBJECT_ID(N'[dbo].[ReportSet]', 'U') IS NOT NULL
    DROP TABLE [dbo].[ReportSet];
GO
IF OBJECT_ID(N'[dbo].[ScreeningHistorySet]', 'U') IS NOT NULL
    DROP TABLE [dbo].[ScreeningHistorySet];
GO
IF OBJECT_ID(N'[dbo].[ScreeningImageSet]', 'U') IS NOT NULL
    DROP TABLE [dbo].[ScreeningImageSet];
GO
IF OBJECT_ID(N'[dbo].[UserSet_Patient]', 'U') IS NOT NULL
    DROP TABLE [dbo].[UserSet_Patient];
GO
IF OBJECT_ID(N'[dbo].[UserSet_MedicalProfessional]', 'U') IS NOT NULL
    DROP TABLE [dbo].[UserSet_MedicalProfessional];
GO
